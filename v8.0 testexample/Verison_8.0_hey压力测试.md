...
接口	并发 / 总请求	QPS	平均延迟	成功率	状态码分布	结论
HealthHandler	100 / 10000	17827	5.5ms	100%	200:10000	✅ 极高性能，稳定无错
EchoRequestHandler	50 / 5000	17727	2.8ms	100%	200:5000	✅ 极高性能，序列化极快
SlowHandler?ms=10	100 / 10000	9226	10.7ms	100%	200:10000	✅ 符合预期
SlowHandler?ms=200	50 / 1000	247	201.8ms	100%	200:1000	✅ 符合预期
Submit（限流内）	50 / 2000	3684	13.1ms	27.6%	200:552, 429:1448	✅ 无 500，限流生效
Getstatus（缓存命中）	50 / 5000	7362	6.7ms	2.98%	200:149, 429:4851	✅ 正常限流，查询稳定
Getstatus（缓存击穿）	50 / 5000	6829	7.3ms	0%	404:82, 429:4918	✅ 无 500，逻辑正常
404 路由	50 / 5000	18537	2.7ms	100%	404:5000	✅ 路由处理高效
Panic 恢复	20 / 1000	8784	2.2ms	0%	500:1000	✅ 服务未崩溃，中间件正常


并发	总请求（约）	实际 QPS	成功（200）	限流（429）	连接拒绝	平均延迟	P99 延迟	结论
100	220593	7350	3009	217584	0	13.6ms	18.7ms	✅ 稳定，0 错误
200	224976	7494	3015	221961	0	26.7ms	35.5ms	✅ 稳定，0 错误
500	224112	7653	3017	221095	5789	66.5ms	87.0ms	⚠️ 出现连接拒绝
1000	247851	8237	3021	205149	39681	135.3ms	190.0ms	⚠️ 连接拒绝大幅增加
...
配置
  ...
  接口	并发 / 总请求	QPS	平均延迟	成功率	状态码分布	结论
HealthHandler	100 / 10000	18237	5.4ms	100%	200:10000	✅ 极高性能，稳定无错
EchoRequestHandler	50 / 5000	17683	2.8ms	100%	200:5000	✅ 极高性能，序列化极快
SlowHandler?ms=10	100 / 10000	9222	10.7ms	100%	200:10000	✅ 符合预期
SlowHandler?ms=200	50 / 1000	248	201.6ms	100%	200:1000	✅ 符合预期
Submit（限流内）	50 / 2000	5250	9.1ms	26.8%	200:536, 429:1464	✅ 无 500，限流生效
Getstatus（缓存命中）	50 / 5000	7031	7.1ms	3.1%	200:156, 429:4844	✅ 正常限流，查询稳定
Getstatus（缓存击穿）	50 / 5000	7008	7.1ms	0%	404:80, 429:4920	✅ 无 500，逻辑正常
404 路由	50 / 5000	17896	2.8ms	100%	404:5000	✅ 路由处理高效
Panic 恢复	20 / 1000	8568	2.3ms	0%	500:1000	✅ 服务未崩溃，中间件正常

并发	总请求（约）	实际 QPS	成功（200）	限流（429）	连接拒绝	平均延迟	P99 延迟	结论
100	223202	7438	3008	220194	0	13.4ms	17.7ms	✅ 稳定，0 错误
200	219936	7327	3016	216920	0	27.3ms	35.4ms	✅ 稳定，0 错误
500	223229	7431	3017	214176	6042	68.6ms	88.5ms	⚠️ 出现连接拒绝
1000	249729	8294	3021	201510	45168	137.2ms	192.8ms	⚠️ 连接拒绝大幅增加
